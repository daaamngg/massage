    ...
    <section id="top" className="relative flex min-h-screen items-center">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 pb-24 pt-32 sm:px-8">
        <div className="max-w-3xl">
          ...
          >
            Массаж и косметология в Самаре с 2011 года. Авторские методики,
            опытные руки и атмосфера, в которой уходит напряжение, а мысли
            затихают. Мастерская Натальи Хасаншиной — две студии в городе.
          </p>
